...
- Thuật ngữ này đề cập đến chủ sở hữu dữ liệu trong kinh doanh, không phải chủ sở hữu hoặc nhà cung cấp hệ thống CNTT.
...
- Họ thường hợp tác với các kiến trúc sư dữ liệu chuyên môn trong các nhiệm vụ như mô hình hóa dữ liệu và truyền đạt yêu cầu dữ liệu cho các đội ngũ CNTT.
...
- **Nhân****viên**phát triển**phần mềm**xây dựng các đường ống dữ liệu, triển khai kiến trúc dữ liệu, tạo giao diện truy cập dữ liệu và tích hợp chính sách dữ liệu vào hệ thống CNTT.
